...
class TableAnalyseOffice extends Component {
    constructor() {
        super()
        ...
        this.state = {
            office_analyses: [],
            filters: {},
            is_office_analyses_loaded: false,
    ...
    render() {
        ...
        // render office analyses
        let officeAnalysesJsx = ''
        if (this.state.is_office_analyses_loaded) {
            officeAnalysesJsx = this.state.office_analyses.map((item) => {
                return (
                    <tr>
                        <td>{item._id.office.office_name}</td>
...
export default TableAnalyseOffice